...
\noindent\textbf{注意（2026-08-01 参数集变更）：}本章数值均基于旧参数集（m=2.6\,kg、kT=2.2e-5、wMax=900、a=b=0.62\,m、24\,m/s 巡航），\texttt{aircraft-model.json} v0.2.0 已回写为 TandemVec\_FCS 实机构型（m=0.7\,kg、kT=1.04e-5、wMax=1150、a=b=0.315\,m，新配平 28\,m/s 四方程，见 \texttt{scripts/trim\_solve.py}）。本章线性化模态/积分精度数值需按新参数集重算后方可作为当前结论引用；推导方法与框架不变。
