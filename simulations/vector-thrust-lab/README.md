...
- 28 m/s 四方程配平参数（v0.2.0，`scripts/trim_solve.py` 求解）：`aTrim=4.122°`、`thrTrim=0.192272`、`dtTrim=-18.702°`、`dfTrim=-1.739°`；摆角滑块为相对配平增量。油门开环下配平点呈弱 phugoid 慢发散（10 s 空速衰减约 12%），为模型固有行为
