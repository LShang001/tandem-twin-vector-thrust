...
$K_p=16.042818$、$K_i=5.729578$，航向$K_p=11.459156$。考虑航向差速
电机通道的低频积分作用，2026-08-12将航向$K_i$保守下调25\%至
$4.297184$，对应$T_i=K_p/K_i$ 由2.0\,s增至约2.67\,s。其输出、
输出限幅和积分限幅均以deg/s$^2$计。进入物理力矩层前，
\texttt{ControlUnits::dps2ToRadps2}只执行一次$\pi/180$转换，得到
$\boldsymbol\nu=\boldsymbol\alpha_{\mathrm{cmd}}$（rad/s$^2$）。量纲迁移时的数值由迁移前
0.28/0.20/0.10整体乘$180/\pi$得到，当时物理指令严格保持；
2026-08-12调参只有意改变航向积分增益，比例增益与单次单位转换不变。
...
$K_p=16.042818/16.042818/11.459156$、
$K_i=5.729578/5.729578/4.297184$，进入物理层前
统一转换为rad/s$^2$；
